...
public class StCompanyUpdateTask {
	...
	private String buildUrl(int page){
		...
		sb.append("http://quotes.money.163.com/hs/service/diyrank.php?query=NODEAL%3AFXJS&fields=NO%2CSYMBOL%2CNAME%2CPRICE%2CTCAP%2CMCAP&count=100&type=query&page="+page);
		return sb.toString();
	}
